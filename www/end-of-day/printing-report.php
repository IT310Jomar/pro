...
#cashcount_printing .modal-content {
    position: absolute; 
    top: 50%; 
    left: 50%;
...
#cashcount_printing .modal-footer {
    position: absolute;
    bottom: 0;
    right: 0;
    padding: 10px;
...
<div class="modal" id="cashcount_printing" tabindex="0" style="background-color: rgba(0, 0, 0, 0.5);">
    <div class="modal-dialog modal-dialog-centered" max-width="50%">
        <div class="modal-content">
            <div class="modal-body">
                <p id="animated-text">
                    <!-- Wrap each letter in a span -->
                    <span>P</span><span>R</span><span>I</span><span>N</span><span>T</span><span>I</span><span>N</span><span>G</span> <span>C</span><span>A</span><span>S</span><span>H</span> <span>C</span><span>O</span><span>U</span><span>N</span><span>T</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-footer">
        <button class="donePrinting">DONE</button>
    </div>  
</div>
