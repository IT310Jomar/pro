...
<div class="modal" id="zread_printing" tabindex="0" style="background-color: rgba(0, 0, 0, 0.5);">
    <div class="modal-dialog modal-dialog-centered" max-width="50%">
        <div class="modal-content">
            <div class="modal-body">
                <p id="animated-text">
                    <!-- Wrap each letter in a span -->
                    <span>P</span><span>R</span><span>I</span><span>N</span><span>T</span><span>I</span><span>N</span><span>G</span> <span id="reportType">Z</span><span>-</span><span>R</span><span>E</span><span>A</span><span>D</span><span>I</span><span>N</span><span>G</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-footer">
        <button class="donePrinting_zRead">DONE</button>
    </div>  
</div>
