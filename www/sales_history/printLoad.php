...
#modalPrintLoadData .modal-content {
    position: absolute; 
    top: 50%; 
    left: 50%;
...
#modalPrintLoadData .modal-footer {
    position: absolute;
    bottom: 0;
    right: 0;
    padding: 10px;
...
<div class="modal" id="modalPrintLoadData" tabindex="0" style="background-color: rgba(0, 0, 0, 0.5);">
    <div class="modal-dialog modal-dialog-centered" max-width="50%">
        <div class="modal-content">
            <div class="modal-body">
            <p id="animated-text">
                <!-- Wrap each letter in a span -->
                <span>P</span><span>R</span><span>I</span><span>N</span><span>G</span> <span>Y</span><span>O</span><span>U</span><span>R</span> <span>R</span><span>E</span><span>C</span><span>E</span><span>I</span><span>P</span><span>T</span>
            </p>
            </div>
        </div>
    </div>   
