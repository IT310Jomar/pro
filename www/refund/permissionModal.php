...
<div class="modal" id="permModal"   tabindex="0" style="background-color: rgba(0, 0, 0, 0.4); overflow: hidden; z-index: 2000;">
      ...
      <button id="permButton" class="close-button" style="font-size:larger">&times;</button>
         <div class="modal-title">
          ...
          <div class="warningCard">
            <div style="width: 100%" >
                <h6 style="display:flex; align-items:center;justify-content: center;margin-bottom: 0;">To grant access to&nbsp;<span style="color:#FF6900">Refund</span>&nbsp;,enter</L></h6>
            ...
            <div style="display:flex; align-items:center;justify-content: center;">
               <div style="margin-right: 10px" class="svg_icon">
                ...
                <button type="submit" name="login" class="permissions form-control primary-color-btn" style="width: auto; border: none; border-radius: 0; margin-top: 1vh" >Continue</button>
               </div>
          </div>
