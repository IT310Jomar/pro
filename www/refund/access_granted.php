...
<div class="modal" id="granted_modal"  tabindex="0" style="background-color: rgba(0, 0, 0, 0.3); overflow: hidden; z-index: 2000;">
    ...
    <div class="modal-content">
      ...
      <div class="warningCard">
            ...
            <div style="display: flex; align-items: center; width: 75%; justify-content: center; flex-direction: column;">
              ...
              <h5 style="font-family: Century Gothic;color:#FF6900">ADMIN</h5>
            </div>
      </div>
