<style>
  ...
  #process_modal .warning-container {
    display: flex;
    align-items: center;
  }

  #process_modal .warning-container svg {
    width: 35px;
    height: 35px;
    margin-right: 0.5em;
    margin-left: 1em;
  ...
  #process_modal .continueButtonContainer {
    margin-top: 1em;
    text-align: right;
    margin-bottom: 0.5em;
    margin-right: 0.95vw;
...
<div class="modal" id="process_modal"  tabindex="0" style="background-color: rgba(0, 0, 0, 0.7); overflow: hidden; z-index: 2000;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <button id="processing" class="close-button" style="font-size: larger;">&times;</button>
      ...
      <div class="warningCard">
            ...
            <img class="resized-images" src="./assets/img/Picture1.png">
            </div>
          
            <div style="display: flex; align-items: center; width: 50%; justify-content: left; flex-direction: column; margin-top: 50px;">
  <p style="font-family: Century Gothic; font-size: 1vw; color: #566573;"><b>RETURN & EXCHANGE</b></p>
  <span style="font-family: Century Gothic;  color: #FF6900;font-size: 1vw; "><b>[PROCESSING]</b></span>
</div>

      </div>
      <div style="display:flex; align-items: right; justify-content: right">
        <button onclick="processCloseModal()" class="validContinue">CONTINUE</button>
      </div>
    </div>
  </div>
</div>
