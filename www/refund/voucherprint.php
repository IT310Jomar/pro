...
#modalVoucherPrint .modal-content {
    position: absolute; 
    top: 50%; 
    left: 50%;
...
#modalVoucherPrint .modal-footer {
    position: absolute;
    bottom: 0;
    right: 0;
    padding: 10px;
...
<div class="modal" id="modalVoucherPrint" tabindex="0" style="background-color: rgba(0, 0, 0, 0.3);">
        <div class="modal-content">
          <div class="modal-body">
          <p id="animated-text">
                <!-- Wrap each letter in a span -->
                <span>P</span><span>R</span><span>I</span><span>N</span><span>T</span><span>I</span><span>N</span><span>G</span> <span>V</span><span>O</span><span>U</span><span>C</span><span>H</span><span>E</span><span>R</span><span>.</span><span>.</span><span>.</span>
            </p>
          </div>
         </div> 
         <div class="modal-footer">
            <button id="done-button" class="doneVoucher" >DONE</button>
      </div>
</div>
<script>
$('.doneVoucher').on('click', function(){
