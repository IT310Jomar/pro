...
<div class="modal" id="modalLoadData" tabindex="0" style="background-color: rgba(0, 0, 0, 0.5);">
    <div class="modal-dialog modal-dialog-centered" max-width="50%">
        <div class="modal-content">
            <div class="modal-body">
            <p id="animated-text">
                <!-- Wrap each letter in a span -->
                <span>L</span><span>O</span><span>A</span><span>D</span> <span>D</span><span>A</span><span>T</span><span>A</span> <span>S</span><span>E</span><span>R</span><span>V</span><span>E</span><span>R</span>
            </p>
            </div>
        </div>
    </div>   
